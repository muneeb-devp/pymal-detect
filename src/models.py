...
# Wrapper for CatBoost to make it compatible with scikit-learn 1.8.0+
class CatBoostClassifier(_CatBoostClassifier, BaseEstimator, ClassifierMixin):
    """CatBoost wrapper for scikit-learn 1.8.0+ compatibility"""
    pass
